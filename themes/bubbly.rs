...
pub fn style() -> Style {
    Style {
        ...
        spacing: Spacing {
            item_spacing: Vec2 { x: 10.0, y: 4.0 },
        ...
        visuals: Visuals {
            ...
            widgets: Widgets {
                noninteractive: WidgetVisuals {
                    ...
                    bg_stroke: Stroke {
                        width: 1.0,
                        color: Color32::from_rgba_premultiplied(118, 118, 118, 255),
                    },
                    rounding: Rounding {
                        nw: 2.0,
                        ne: 2.0,
                ...
                inactive: WidgetVisuals {
                    bg_fill: Color32::from_rgba_premultiplied(104, 104, 104, 255),
                    weak_bg_fill: Color32::from_rgba_premultiplied(89, 89, 89, 255),
                    bg_stroke: Stroke {
                        width: 0.0,
            ...
            selection: Selection {
                bg_fill: Color32::from_rgba_premultiplied(194, 194, 194, 255),
                stroke: Stroke {
                    width: 1.0,
                    color: Color32::from_rgba_premultiplied(45, 45, 45, 255),
                },
            },
            ...
            window_fill: Color32::from_rgba_premultiplied(53, 53, 53, 255),
            window_stroke: Stroke {
                width: 1.600000023841858,
                color: Color32::from_rgba_premultiplied(124, 123, 123, 255),
            },
            ...
            panel_fill: Color32::from_rgba_premultiplied(50, 50, 50, 255),
            popup_shadow: Shadow {
                extrusion: 16.0,
                color: Color32::from_rgba_premultiplied(0, 0, 0, 96),
            },
