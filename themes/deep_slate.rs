...
pub fn style() -> Style {
    Style {
        ...
        spacing: Spacing {
            item_spacing: Vec2 { x: 10.0, y: 5.0 },
            ...
            button_padding: Vec2 { x: 6.0, y: 6.0 },
            menu_margin: Margin {
                left: 6.0,
                right: 6.0,
                top: 6.0,
        ...
        visuals: Visuals {
            ...
            widgets: Widgets {
                ...
                inactive: WidgetVisuals {
                    bg_fill: Color32::from_rgba_premultiplied(31, 31, 31, 255),
                    weak_bg_fill: Color32::from_rgba_premultiplied(21, 21, 21, 255),
                    bg_stroke: Stroke {
                        width: 0.0,
                ...
                hovered: WidgetVisuals {
                    bg_fill: Color32::from_rgba_premultiplied(42, 42, 42, 255),
                    weak_bg_fill: Color32::from_rgba_premultiplied(26, 26, 26, 255),
                    bg_stroke: Stroke {
                        width: 1.2000000476837158,
                        color: Color32::from_rgba_premultiplied(0, 45, 187, 255),
                    },
                    rounding: Rounding {
                        nw: 3.0,
                        ne: 3.0,
            ...
            selection: Selection {
                bg_fill: Color32::from_rgba_premultiplied(0, 38, 123, 255),
                stroke: Stroke {
                    width: 1.0,
                    color: Color32::from_rgba_premultiplied(192, 222, 255, 255),
                },
            },
            hyperlink_color: Color32::from_rgba_premultiplied(0, 147, 241, 255),
            ...
            window_rounding: Rounding {
                nw: 7.099999904632568,
                ne: 7.099999904632568,
                sw: 7.099999904632568,
                se: 7.099999904632568,
            },
            window_shadow: Shadow {
                extrusion: 32.0,
                color: Color32::from_rgba_premultiplied(0, 0, 0, 96),
            },
            window_fill: Color32::from_rgba_premultiplied(8, 8, 8, 255),
            window_stroke: Stroke {
                width: 0.800000011920929,
                color: Color32::from_rgba_premultiplied(43, 43, 43, 255),
            },
            ...
            panel_fill: Color32::from_rgba_premultiplied(16, 16, 16, 255),
            popup_shadow: Shadow {
                extrusion: 16.0,
                color: Color32::from_rgba_premultiplied(0, 0, 0, 96),
            },
